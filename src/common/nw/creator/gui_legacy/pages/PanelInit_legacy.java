...
public class PanelInit_legacy extends JPanel implements IPageHandler, IDropFileHandler {
	...
	private JCheckBox prop_GenerateConfig;
	 ...
	 * Create the panel.
	 */
	public PanelInit_legacy(Creator creator) {
		...
		btnOpen.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				String file = Utils.openFile(PanelInit_legacy.this, null);
				if (file != null) {
		...
		prop_GenerateConfig = new JCheckBox("Generate a properties file", true);
